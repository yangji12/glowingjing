...
- Network Theory (Granovetter, Watts-Strogatz, Barabási-Albert)
...
- Validation requirement: κ > .70 or Krippendorff's α > .67 against human coders on held-out sample
...
- ⚠️ WARNING: pre-trained model applied to out-of-domain text; no sensitivity analysis; missing data documentation
